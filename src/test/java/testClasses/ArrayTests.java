...
public class ArrayTests extends BaseClass {
    ...
    public Object[][] CodeData1() throws IOException, OpenXML4JException {
        return new Object[][] {
            {"ArrayPracticeQnsQ1", 0, "Element Found"},
            {"ArrayPracticeQnsQ1", 1, " Not Found"},
        };
    }

    @DataProvider(name = "Pythoncode3")
    public Object[][] CodeData2() throws IOException, OpenXML4JException {
        return new Object[][] {
            {"pythonCode", 0, "Even number"},
            {"pythonCode", 1, "SyntaxError"},
            {"pythonCode", 2, "MaxConsecutive Ones"},
            {"pythonCode", 3, "SyntaxError"},
        };
    }
    ...
    @Test(priority = 11, dataProvider = "Pythoncode1")
    ...
    @Test(priority = 13, dataProvider = "Pythoncode3")
    ...
    @Test(priority = 14, dataProvider = "Pythoncode1")
    ...
    @Test(priority = 15, dataProvider = "Pythoncode3")
    ...
    @Test(priority = 16, dataProvider = "Pythoncode1")
    ...
    @Test(priority = 17, dataProvider = "Pythoncode")
    ...
    @Test(priority = 18, dataProvider = "Pythoncode")
